...
library(readxl)
OffNFLSalary <-
  read_excel("NFLPlayerSalaryData.xlsx",
...
sink(
  "QB Bootstrap Measures of Relative Importance.txtf",
  type = "output",
  append = FALSE,
  split = TRUE
)
